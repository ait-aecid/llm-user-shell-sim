# experiments/bert_360_nested.py
#
# Run:
#   python -m experiments.bert_360_nested
#
# Example debug run (only first 5 outer splits):
#   python -m experiments.bert_360_nested --limit_outer 5
#
# What it does:
...
#     - run bert_pipeline.search() over candidate grid
