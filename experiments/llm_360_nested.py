# experiments/llm_360_nested.py
#
# Run:
#   python -m experiments.llm_360_nested
#
# Debug (only first 3 outer splits):
#   python -m experiments.llm_360_nested --limit_outer 3
#
# Optional:
#   python -m experiments.llm_360_nested --use_llm_fallback 0
#
# What it does:
...
#     - run llm_pipeline.search() over candidate grid
